...
let saveuser = async (req, res) => {
    ...
    try {
        ...
        let userSaved = await connection.query('INSERT INTO Usuarios (Nombre_usuario,contrasenia,correo,Apellido_usuario) values (?,?,?,?)', [name, password, email, lastname])
...
let listUsers = async (req, res) => {
    ...
    try {
        let queryUsers = await connection.query('SELECT Nombre_usuario , Apellido_usuario , Correo from Usuarios ')
...
let listUser = async (req, res) => {
    ...
    console.log(id);
    try {
        let queryuser = await connection.query('SELECT Nombre_usuario , Apellido_usuario , Correo from Usuarios WHERE id_usuarios = ?', id)
