...
let { resourceName, description, responsable, stateType, priority } = req.body
    ...
    try {
        ...
        let querySavedResource = await connection.query('INSERT INTO Recursos (nombre_recurso,Descripcion,Responsable,Tipo_estado_id_estado,Prioridad_id_prioridad) VALUES (?,?,?,?,?)', [resourceName, description, responsable, stateType, priority])
